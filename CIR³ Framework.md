...
flowchart TD
  ...
  subgraph TOOL[Operational Systems & Controls]
    ...
    ENTRA[Entra ID PIM/MFA (IAM)]
    DBX[Databricks + Unity Catalog (Data/Access)]
    MLF[MLflow (Model Registry/Lineage/Metrics)]
    PURV[Microsoft Purview (Lineage/Classif./DLP)]
  ...
  subgraph OUT[Auto-Generated Outputs]
    ...
    O6[Tender/Customer Packs (1-click)]
  end
